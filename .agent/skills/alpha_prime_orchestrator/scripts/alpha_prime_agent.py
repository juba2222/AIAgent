...
3. تتبع الأموال الذكية: راقب 13F (وارن بافيت)، وتداولات الكونجرس، وتمركزات الماركت ميكر (GEX)، وتقارير COT للفيوتشرز.
4. هيكل المزاد (AMT/TPO): السوق يسهل التجارة. ابحث عن القيمة العادلة، الـ LVN مناطق رفض، والـ HVN مناطق قبول. إذا اختلف شكل بروفايل اليوم (Temporal) عن البروفايل الكلي، فهذا يعني "تصحيحاً تكتيكياً" داخل اتجاه هيكلي أكبر.
